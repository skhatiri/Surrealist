...
Surrealist and Aerialist has also been privately extended to generated and execute navigation tests for the **[ANYmal robot](https://www.anybotics.com/robotics/anymal/)**. 
...
- Impliment usecase specific **Solution** for the test generation search taking [Solution.py](./surrealist/search/solution.py) (or one of its child classes) as parent. 
